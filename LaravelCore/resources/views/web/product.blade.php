            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-5 mb-4">
                        <div class="swiper mySwiper2" style="--swiper-navigation-color: #9a9a9a; --swiper-pagination-color: #fff">
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="product-variable-tab-menu">
                                        <div class="nav">
                                            @foreach ($product->variables as $index => $variable)
                                                <a class="nav-link mb-2 {{ $index === 0 ? 'active show' : '' }}" data-bs-toggle="tab" href="#variable{{ $variable->id }}">
                                                    {!! $variable->name !!}
                                                </a>
                                            @endforeach
                                        </div>
                                    ...
                                    @foreach ($product->variables as $index => $variable)
                                        <div class="tab-pane fade {{ $index === 0 ? 'active show' : '' }}" id="variable{{ $variable->id }}">
                                            <form class="cart-form" action="{{ route('cart.add') }}" method="post">
                                                ...
                                                <div class="preview-price-container d-flex align-items-center gap-2 mb-3" data-variable-id="{{ $variable->id }}">
