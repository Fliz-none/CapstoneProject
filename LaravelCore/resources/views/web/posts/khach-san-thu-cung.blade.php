        ...
        <div class="key-section">
            <div class="container">
                <div class="row align-items-center justify-content-center mb-4">
                    <div class="col-12 col-md-10 p-2 p-md-5 text-center">
                        <h2 class="text-dark fw-semibold fs-1 mb-3">Khách sạn thú cưng</h2>

                        <p class="justify">Khách sạn thú cưng còn gọi là Pet Hotel, là một trong những loại hình
                            dịch vụ chăm sóc thú cưng dành cho những người bận rộn với công việc, đi du lịch,
                            không đủ thời gian chăm sóc các bé.</p>
                        <p class="mt-4">
                    ...
                    <div class="col-12 col-md-10 p-2">
                        <div class="img my-4 img-style">
                            <div class="img-inner">
                                <img class="img-fluid" src="{{ asset('images/khac-san-img.jpg') }}" alt="dịch vụ thú cưng" loading="lazy">
                            </div>
                        </div>
                    </div>
                </div>
