...
<div id="print-container" style="font-size: 75%; color: #000000">
        ...
        <div class="container content">
            <div class="row mb-3">
                ...
                <div class="col-4 ms-auto">
                    <p class="mb-0">Mã phiếu: <strong>{{ $ultrasound->code }}</strong></p>
                    <p class="mb-0">Phiếu khám: <strong>{{ $info->code }}</strong></p>
                    <p class="mb-0">Ngày tạo: {{ $ultrasound->created_at->format('d/m/Y H:i') }}</p>
            ...
            <div class="my-4 pt-3 text-center border-top">
                <h4 class="text-uppercase">Phiếu Siêu Âm</h4>
            </div>
            <div class="row my-3">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <h5 class="text-uppercase">Thông Tin Phiếu Siêu Âm </h5>
                </div>
            </div>
            <div class="row justify-content-between">
                <div class="col-12">
                    <p class="mb-0">Nội dung: <strong> {{ $ultrasound->detail->_service->name }}</strong></p>
                    <table class="table">
                        <thead>
                            <tr>
                    ...
                    <p class="mb-0">Kết luận: <strong> {!! nl2br($ultrasound->conclusion) !!} </strong>
                    </p>
                </div>
            </div>
            ...
            <div class="row border-top justify-content-between my-3">
                ...
                <div class="col-5 pt-3 text-center">
                    ...
                    <p class="mb-5">
                        <em><strong>{{ optional($ultrasound->technician)->name }}</strong></em>
                    </p>
                </div>
            </div>
        </div>
    ...
    @if ($ultrasound->details)
        @foreach (json_decode($ultrasound->details, true) as $e => $detail)
            @if (isset($detail['images']))
                @foreach ($ultrasound->galleryUrl[$e] as $e => $gallery)
