        ...
        <div class="container content">
            <div class="row mb-3">
                ...
                <div class="col-4 ms-auto">
                    <p class="mb-0">Mã phiếu: <strong>{{ $indication->code }}</strong></p>
            ...
            <div class="my-4 pt-3 text-center border-top">
                <h4 class="text-uppercase">PHIẾU CHỈ ĐỊNH DỊCH VỤ</h4>
            </div>
            <div class="row my-3">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <h5 class="text-uppercase">Thông tin dịch vụ</h5>
                </div>
            </div>
            <div class="row justify-content-between">
                <div class="col-12 p-1">
                    <table class="table key-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-star">{{ $indication->detail->_service->name }}</td>
                                <td class="text-center">{{ number_format($indication->detail->_service->price) }}đ</td>
                                <td class="text-center">{{ number_format($indication->detail->quantity) }} {{ $indication->detail->_service->unit ?? 'ĐVT' }}</td>
                                <td class="text-end">{{ number_format($indication->detail->_service->price) }}đ</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
