        ...
        <div class="container content">
            <div class="row mb-3">
                ...
                <div class="col-4 ms-auto">
                    <p class="mb-0">Mã phiếu: <strong>{{ $microscope->code }}</strong></p>
                    <p class="mb-0">Phiếu khám: <strong>{{ $info->code }}</strong></p>
                    <p class="mb-0">Ngày tạo: {{ $microscope->created_at->format('d/m/Y H:i') }}</p>
            ...
            <div class="my-4 pt-3 text-center border-top">
                <h4 class="text-uppercase">Phiếu Soi Kính Hiển Vi</h4>
            </div>
            <div class="row my-3">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <h5 class="text-uppercase">Thông Tin Phiếu Soi Kính Hiển Vi </h5>
                </div>
            </div>
            <div class="row justify-content-between">
                <div class="col-12">
                    <p class="mb-0">Nội dung: <strong> {{ $microscope->detail->_service->name }}</strong></p>
                    <p class="mb-0">Mẫu kiểm tra: <strong> {{ $microscope->sample }}</strong></p>
                    <p class="mb-0">Phương pháp kiểm tra: <strong> {{ $microscope->method }}</strong></p>
                    <p class="mb-0">Kết luận: <strong> {{ $microscope->conclusion }}</strong></p>
                    <p class="mb-0">Khuyến cáo: <strong> {{ $microscope->recommendation }}</strong></p>
                </div>
            </div>
            ...
            <div class="row border-top justify-content-between my-3">
                ...
                <div class="col-5 pt-3 text-center">
                    ...
                    <p class="mb-5">
                        <em><strong>{{ optional($microscope->technician)->name }}</strong></em>
                    </p>
                </div>
            </div>
        </div>
        @if ($microscope->images)
