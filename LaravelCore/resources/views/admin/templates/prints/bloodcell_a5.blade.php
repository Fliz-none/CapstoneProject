    ...
    <div id="print-container">
        ...
        <div class="container content">
            ...
            <div class="my-4 pt-3 text-center border-top">
                <h4 class="text-uppercase">Phiếu Xét Nghiệm Tế Bào Máu</h4>
            </div>
            <div class="row my-3">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <h5 class="text-uppercase">Thông Tin Phiếu Xét Nghiệm Tế Bào Máu</h5>
                </div>
            </div>
            <div class="row justify-content-between">
                <div class="col-12">
                    <p class="mb-0">Nội dung: <strong> {{ $bloodcell->detail->_service->name }}</strong></p>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Chỉ tiêu</th>
            ...
            <div class="row justify-content-between">
                <div class="col-12">
                    <p class="mb-0">Kết luận: <strong>{!! $bloodcell->conclusion !!}</strong></p>
                    <p class="mb-0">Khuyến cáo: <strong>{!! $bloodcell->recommendation !!}</strong></p>
                </div>
            </div>
