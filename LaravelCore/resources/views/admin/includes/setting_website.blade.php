        ...
        <div class="card-body">
            <div class="row justify-content-between align-items-stretch">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <label class="form-label select-image" for="banner_home_1" style="height: 19rem !important"> <img
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <label class="form-label select-image" for="banner_home_2" style="height: 19rem !important"> <img
                            class="img-fluid rounded-4 object-fit-contain h-100 w-100" alt="Banner" onerror="this.src='{{ asset('/images/bg-contact-1.jpg') }}';">
                    </label>
            ...
            <div class="row justify-content-between align-items-stretch">
                ...
                <div class="col-12 col-md-6 mb-3">
                    <h6 class="text-secondary">Banner 1</h6>
                    <label class="form-label select-image" for="banner_store_1" style="height: 19rem !important"> <img
                            class="img-fluid rounded-4 object-fit-contain h-100 w-100" alt="Banner" onerror="this.src='{{ asset('/images/bg-contact-1.jpg') }}';">
                    </label>
                ...
                <div class="col-12 col-md-6 mb-3">
                    <h6 class="text-secondary">Banner 2</h6>
                    <label class="form-label select-image" for="banner_store_2" style="height: 19rem !important"> <img
                            class="img-fluid rounded-4  object-fit-contain h-100 w-100" alt="Banner" onerror="this.src='{{ asset('/images/bg-contact-1.jpg') }}';">
                    </label>
            ...
            <div class="row justify-content-between align-items-stretch">
                ...
                <div class="col-12 col-md-6 mb-3">
                    <h6 class="text-secondary">Banner 1</h6>
                    <label class="form-label select-image" for="banner_post_1" style="height: 19rem !important"> <img
                            class="img-fluid rounded-4 object-fit-contain h-100 w-100" alt="Banner" onerror="this.src='{{ asset('/images/bg-contact-1.jpg') }}';">
                    </label>
                ...
                <div class="col-12 col-md-6 mb-3">
                    <h6 class="text-secondary">Banner 2</h6>
                    <label class="form-label select-image" for="banner_post_2" style="height: 19rem !important"> <img
                            class="img-fluid rounded-4  object-fit-contain h-100 w-100" alt="Banner" onerror="this.src='{{ asset('/images/bg-contact-1.jpg') }}';">
                    </label>
            ...
            <div class="row justify-content-between align-items-stretch">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <label class="form-label select-image" for="banner_contact" style="height: 19rem !important"> <img
                            class="img-fluid rounded-4 object-fit-contain h-100 w-100" alt="Banner" onerror="this.src='{{ asset('/images/bg-contact-1.jpg') }}';">
                    </label>
