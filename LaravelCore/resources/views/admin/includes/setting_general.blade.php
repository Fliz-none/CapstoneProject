        ...
        <div class="card-body">
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" for="company_name">Tên công ty<br />
                    <small class="form-text text-muted" id="company_name-help">Hiển thị trên trang chủ của
                        website</small>
                </label>
                <div class="col-sm-8">
                    <input class="form-control @error('company_name') is-invalid @enderror" id="company_name" name="company_name" type="text" value="{{ $settings['company_name'] }}">
                    @error('company_name')
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input class="form-control @error('company_address') is-invalid @enderror" id="company_address" name="company_address" type="text" value="{{ $settings['company_address'] }}">
            ...
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" for="company_website">Địa chỉ web<br />
                    <small class="form-text text-muted" id="company_website-help">Đường dẫn đến trang web chính
                        thức</small>
                </label>
                <div class="col-sm-8">
            ...
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" for="company_brandname">Tên thương hiệu<br />
                    <small class="form-text text-muted" id="company_brandname-help">Tên thương hiệu của công
                        ty</small>
                </label>
                <div class="col-sm-8">
                    <input class="form-control @error('company_brandname') is-invalid @enderror" id="company_brandname" name="company_brandname" type="text" value="{{ $settings['company_brandname'] }}">
                    @error('company_brandname')
                        <span class="invalid-feedback d-block" role="alert"> <strong>{{ $message }}</strong>
                        </span>
                    @enderror
                </div>
            ...
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" for="company_hotline">Hotline<br />
                    <small class="form-text text-muted" id="company_hotline-help">Số hotline của công ty</small>
                </label>
                <div class="col-sm-8">
                    <input class="form-control @error('company_hotline') is-invalid @enderror" id="company_hotline" name="company_hotline" type="text" value="{{ $settings['company_hotline'] }}">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input class="form-control @error('company_phone') is-invalid @enderror" id="company_phone" name="company_phone" type="text" value="{{ $settings['company_phone'] }}">
                    @error('company_phone')
                        <span class="invalid-feedback d-block" role="alert"> <strong>{{ $message }}</strong>
                        </span>
                    @enderror
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input class="form-control @error('company_email') is-invalid @enderror" id="company_email" name="company_email" type="text" value="{{ $settings['company_email'] }}">
                    @error('company_email')
                        <span class="invalid-feedback d-block" role="alert"> <strong>{{ $message }}</strong>
                        </span>
                    @enderror
            ...
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" for="company_tax_id">Mã số thuế<br />
                    <small class="form-text text-muted" id="company_tax_id-help">Mã số việc kê khai và nộp thuế</small>
                </label>
                <div class="col-sm-8">
                    <input class="form-control @error('company_tax_id') is-invalid @enderror" id="company_tax_id" name="company_tax_id" type="text" value="{{ $settings['company_tax_id'] }}">
            ...
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" for="company_tax_meta">Ngày cấp mã số thuế<br />
                    <small class="form-text text-muted" id="company_tax_meta-help">Ngày mã số thuế được cấp cho công ty</small>
                </label>
                <div class="col-sm-8">
                    <input class="form-control @error('company_tax_meta') is-invalid @enderror" id="company_tax_meta" name="company_tax_meta" type="text" value="{{ $settings['company_tax_meta'] }}">
