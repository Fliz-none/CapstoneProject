        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h1 class="modal-title fs-5 text-white" id="expense-modal-label">{{ __('messages.expense.expense_voucher') }}</h1>
                ...
                <div class="modal-body">
                    <div class="row p-0 p-md-2">
                        <div class="col-12 col-md-7">
                            ...
                            <div class="mb-3 form-group">
                                <label class="form-label" data-bs-toggle="tooltip" data-bs-title="Customer's payment method" for="expense-cash">{{ __('messages.expense.payment_method') }}</label>
                                <div class="d-grid">
                                    <div class="btn-group">
                                        ...
                                        <label class="btn btn-outline-primary" for="expense-card">
                                            {{ __('messages.expense.card') }}
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label data-bs-toggle="tooltip" data-bs-title="Amount of money spent" for="expense-amount">{{ __('messages.datatable.amount') }}</label>
                            ...
                            <div class="form-group">
                                <label data-bs-toggle="tooltip" data-bs-title="Detailed notes about the expense voucher" for="expense-note">{{ __('messages.note') }}</label>
                                <textarea class="form-control" id="expense-note" name="note" type="text" rows="3" placeholder="{{ __('messages.note') }}"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="mb-3 text-end d-flex justify-content-between align-items-center">
                        ...
                        @if (Auth::user()->can(App\Models\User::APPROVE_EXPENSE))
                            <div class="d-inline-block form-check form-switch">
                                ...
                                <label class="form-check-label" data-bs-toggle="tooltip" data-bs-title="Status of the expense voucher" for="expense-status">{{ __('messages.expense.approve') }}</label>
                            </div>
                        @endif
