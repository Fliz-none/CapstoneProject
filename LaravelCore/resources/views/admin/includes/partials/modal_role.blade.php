        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header key-bg-primary">
                    <h4 class="modal-title white">{{ __('messages.roles.role') }}</h4>
                    <button class="btn-close" data-bs-dismiss="modal" type="button" aria-label="Close"> </button>
                </div>
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <label class="col-form-label text-md-end fw-bold fs-5" data-bs-toggle="tooltip" data-bs-title="Name used to identify the user's permissions and responsibilities in the system" for="role-name">{{ __('messages.roles.name') }}</label>
                        </div>
                        <div class="col-md-9">
                            <input class="form-control" id="role-name" name="name" type="text" required autocomplete="off" placeholder="{{ __('messages.roles.placeholder') }}" value="">
                        </div>
                    </div>
                    <div class="row">
                        @php
