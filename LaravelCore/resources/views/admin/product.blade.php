...
@section('content')
                        ...
                        <div class="col-12 col-lg-9 mx-auto">
                            <div class="card card-body">
                                <div class="form-group">
                                    <label class="form-label" for="product-name" data-bs-toggle="tooltip" data-bs-title="The product name used to distinguish it from other products">Product name</label>
    ...
    <div class="col-12 col-lg-3 mx-auto">
        ...
        <div class="card card-body mb-3">
            ...
            <button class="btn btn-info" type="submit">{{ isset($product) ? 'Update' : 'Publish' }}</button>
        </div>
        <!-- END Publish card -->
        <!-- Catalog card -->
        <div class="card card-body mb-3">
            <div class="input-group search-container">
                <label class="form-label d-flex align-items-center text-info mb-0 me-3" data-bs-toggle="tooltip" data-bs-title="Used to classify products into groups." for="product-catalogue-select">Category</label>
                <div class="w-25">
            ...
            @enderror
            <a class="btn btn-sm btn-link mt-3 btn-create-catalogue">Add category</a>
        </div>
        <!-- END Catalog card -->
        <!-- Setting product -->
        <div class="card card-body">
            ...
            <hr class="horizontal dark">
            <div class="form-group">
                <label class="form-label mt-1" for="product-sku" data-bs-toggle="tooltip" data-bs-title="Short identifier for managing products">Product SKU</label>
                <input class="form-control @error('sku') is-invalid @enderror" id="product-sku" name="sku" type="text" value="{{ old('sku') != null ? old('sku') : (isset($product) ? $product->sku : '') }}" placeholder="Product SKU"
                    autocomplete="off">
                @error('sku')
                    <span class="invalid-feedback d-block" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            <div class="form-group">
                <label class="form-label mt-1" for="product-keyword" data-bs-toggle="tooltip" data-bs-title="Keywords that help improve product searchability">Keywords</label>
                <input class="form-control @error('keyword') is-invalid @enderror" id="product-keyword" name="keyword" type="text" value="{{ old('keyword') != null ? old('keyword') : (isset($product) ? $product->keyword : '') }}"
                    placeholder="Keywords to optimize search" autocomplete="off">
                @error('keyword')
                    <span class="invalid-feedback d-block" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group">
                <label class="form-label mt-1" for="product-stock_limit" data-bs-toggle="tooltip" data-bs-title="Minimum stock quantity. If less than this amount, a notification will be received">Minimum stock</label>
            ...
            <div class="form-group mt-3">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="product-allow_review">Allow review</label>
                </div>
                @error('allow_review')
                    <span class="invalid-feedback d-block" role="alert">
                        <strong>{{ $message }}</strong>
