...
return [
    ...
    'barcode' => 'Mã vạch',
    'invalid_score' =>'Không hợp lệ',
    'point' => 'Điểm',
    'use'=>'Sử dụng',
    'debt' =>'Đang nợ',
    'current_has' => 'Hiện tại có',
    'purchased' => 'Đã mua',
    'times' =>'lần',
    'account_since' => 'Tài khoản từ ngày',
    'not_purchased' => 'Chưa mua hàng lần nào',
    'items' => 'sản phẩm',
    'amount_due' => 'Tổng trả',
    'order_new' => [
        'search' => 'Tìm sản phẩm (F3)',
        'search_cus' => 'Tìm khách hàng (F4)',
        'tab' => 'Tối đa 5 đơn hàng',
        'content'=>'Hãy thêm sản phẩm để tạo đơn hàng',
    ]
];
