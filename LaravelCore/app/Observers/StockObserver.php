...
class StockObserver
{
    ...
    {  // Nếu chạy qua CLI (php artisan) thì không log
        ...
        Log::create([
            ...
            'action' => $action,
            'type' => 'Stock',
            'object' => 'STO' . str_pad($Model->id, 5, "0", STR_PAD_LEFT),
    ...
    public function created(Stock $model)
    {
        ...
        public function updating(Stock $model)
    {
     ...
     * @return void
     */
    public function deleted(Stock $model)
    {
     ...
     * @return void
     */
    public function restored(Stock $model)
    {
        //
    }
     ...
     * @return void
     */
    public function forceDeleted(Stock $model)
    {
        //
    }
}
