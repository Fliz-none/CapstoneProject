...
class ExpenseObserver
{
    ...
    protected function logAction($Model, $action, $beforeChange = [], $afterChange = [])
    {
        ...
        Log::create([
            ...
            'action' => $action,
            'type' => 'Expense',
            'object' => 'EXP' . str_pad($Model->id, 5, "0", STR_PAD_LEFT),
    ...
    public function created(Expense $model)
    {
        ...
        public function updating(Expense $model)
    {
     ...
     * @return void
     */
    public function deleted(Expense $model)
    {
     ...
     * @return void
     */
    public function restored(Expense $model)
    {
        //
    }
     ...
     * @return void
     */
    public function forceDeleted(Expense $model)
    {
        //
    }
}
